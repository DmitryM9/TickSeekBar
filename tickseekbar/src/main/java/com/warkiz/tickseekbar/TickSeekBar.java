    ...
    private void drawTickMarks(Canvas canvas) {
        ...
        for (int i = 0; i < mTickMarksX.length; i++) {
            ...
            if (mShowTickMarksType == TickMarkType.OVAL) {
                ...
                canvas.drawRect(mTickMarksX[i] - rectWidth / 2.0f, mProgressTrack.bottom + spaceBtwBarToDivider, mTickMarksX[i] + rectWidth / 2.0f, mProgressTrack.bottom + mTickMarksSize + spaceBtwBarToDivider, mStockPaint);
            }
        }
    }
